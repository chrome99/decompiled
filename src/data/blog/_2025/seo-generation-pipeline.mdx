...
title: Building a webpage content generation pipeline
featured: false
draft: false
...
<!-- something about how ui sucks and  you can build a scraper using playwright record or using playwright mcp. -->
