...
description: "A practical approach to advanced Git"
pubDatetime: 2026-04-24T21:31:17.838Z
featured: false
draft: false
tags:
  - git
...
{/* ## git diff! */}
{/**/}
{/* 1. you can diff most files. not that you would want to. but for sqlite files it makes a ton of sense, even if you are not comitting it (git ignored files) */}
{/* 2. diff with ast! incomprehensible that most people don't use this */}

## 6. Quick note on Worktrees

{/* - add about syncwt */}
{/* - consolidate wtr wtg into this section */}
{/* - use stashes to move code between worktrees? or maybe just teleport command that isn't tied to git? */}
...
{/* ## git bisect */}
{/**/}
{/* - add git bisect section. explain conceptually. also short practical example. */}
{/**/}
{/* ## git history excavations (log blame etc.) */}
{/**/}
{/* explain conceptually. maybe tricks with claude? maybe mention Agam's prompt of finding common issues or repeating issues across repos. */}
